    ...
    <div class="container d-none d-lg-block">
      <div class="row">
        <div class="col-12 text-center mb-4 mt-5">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Tinkering with paper circuit<span class="text-primary">.</span> </a></h1>
          </div>
      </div>
    </div>
    ...
    <div class="footer py-5 border-top text-center">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <p class="mb-0">
              Made with <i class="icon-heart" aria-hidden="true"></i> by Tinkering With Paper Circuit
            </p>
          </div>
        </div>
      </div>
